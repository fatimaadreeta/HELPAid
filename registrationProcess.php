...
<nav class="navbar navbar-expand-lg navbar-expand-md">
    ...
    <div class="successful-box w-50 mx-auto text-center mb-2">
        <h1 class="h1 p-5"><?php echo $message ?></h1>
        <p class="p-2 fst-bold">Thank you for registering. Wish you have a pleasant experience with us!</p>
        <a href="index.html" class="button btn btn-success me-1">Back to home page </a> 
    </div>
