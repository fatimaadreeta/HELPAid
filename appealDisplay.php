...
$s = "select * from appeals where outcome = 'ACTIVE'";
...
<body class="body">
    ...
    <div class="form-box container-fluid p-lg-5 p-md-5 p-2 mb-5">
        ...
        <small class="text-danger pb-1">(Disclaimer: Only click on ACTIVE appeals. Any donation made to NOT ACTIVE Link will not be recorded)</small>
        ...
        <thead>
            ...
            if($row['outcome'] == "ACTIVE"){
                ...
                ?>
            <td><a href="donate.php?<?php echo 'appealID='.$row['appealID'] ?>"><?php echo $link?></a></td>
            </tr>
            <?php
            $f++;
            }
