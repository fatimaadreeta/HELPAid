...
if(isset($_GET['appealID'])){
    ...
    header("location:recordDisbursement.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="body">
    ...
    <div class="form-box container-fluid p-lg-5 p-md-5 p-2 my-5">
        <h1 class="h1 p-lg-3 p-md-3 mb-3 p-0 text-center">Record disbursement</h1>
        <form class="form mx-auto" action="disbursed.php" method="post">
            <div class="form-group mb-3">
                <p class="my-1 fst-italic mb-2">AppealID: <strong><?php echo $appealID?></strong></p>
                <p class="my-1 fst-italic mb-2">Applicant ID: <strong><?php echo $applicantID?></strong></p>
            </div>
            <div class="form-group">
                <label for="date">Disbursement Date</label>
            <input type="date" id="date" name="date" class="form-control" placeholder="Select Today's Date" required>
            </div>
            <div class="form-group">
                <label for="cashAmount">Cash Amount</label>
            <input type="number" id="cashAmount" name="cashAmount" class="form-control" placeholder="Enter amount">
            </div>
            <div class="form-group">
                <label for="goods">Goods</label>
            <input type="text" id="goods" name="goods" class="form-control" placeholder="Goods recorded for appeal <?php echo $appealID?>">
            </div>
            ...
            <div class="form-group mt-3">
                <button type="submit" class="button btn btn-success">Record Disbursement</button>
            </div>
        </form>
    </div><!--footer-->
