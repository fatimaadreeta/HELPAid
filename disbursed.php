...
$disburseDate $_POST['applicantID'];

$s = "insert into disbursements (DisbursementDate, CashAmount, GoodsDisbursed, appealID, applicantID) values ('$disburseDate','$cash','$goods','$appealID','$applicantID')";

mysqli_query($con, $s);

$st = "UPDATE appeals SET outcome ='ACTIVE' WHERE appealID = '$appealID'";
...
<body class="body">
    ...
    <div class="container-fluid p-lg-5 p-md-5 p-2 my-5 text-center">
        <h1 class="h1 p-lg-5 p-md-1 mb-1 p-0">Disbursement recorded for <?php echo $applicantID ?></h1>
        <form action="representativeMenu.php" class="d-inline-block">
            <button type="submit" name="submit" class="button btn btn-success me-1">Go To Main Menu</button>
        </form>
