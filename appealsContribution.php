...
<nav class="navbar navbar-expand-lg navbar-expand-md">
    ...
    <div class="table-display container-fluid p-lg-5 p-md-5 p-2 mb-5">
    ...
    <p class="ms-3 my-1 fst-italic">Organization Name: <strong><?php echo $orgName?></strong></p>
        <small class="text-danger pb-1">(Disclaimer: Please record the Contribution details and do not change the information)</small>
    ...
    ?>
        ...
        <thead>
            ...
            <td><a href="HELP-Aid-Contact-Portal-Siva_HELP_AID/contribution.php?<?php echo 'appealID='.$rowApp['appealID'] ?>" target="__blank">Record Contribution for Appeal <?php echo $rowApp['appealID']?></a></td>
            </tr>
            <?php
            $f++;
            }
