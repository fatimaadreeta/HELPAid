...
$amount = $_POST['amount'];
$pay = $_POST['paymentChannel'];
$ref = $_POST['reference'];
$desc = $_POST['description'];
$est = $_POST['estimatedValue'];
$appealID = $_POST['appealID'];

//select from table-name where column-name = $var
$s = "UPDATE appeals SET outcome = 'NOT ACTIVE{amount: $amount, channel: $pay, reference: $ref, description: $desc, estimated value: $est}' WHERE appealID= '$appealID'";
...
<body class="body">
    ...
    <div class="container-fluid p-lg-5 p-md-5 p-2 my-5">
        <h1 class="h1 p-lg-3 p-md-3 mb-3 p-0 text-center">Thank you for Donating! See you soon</h1>
        <a href="index.html" class="a d-block p-2 px-5 w-60 mx-auto btn btn-success">Back to Home Page</a>
    </div>
