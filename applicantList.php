...
if(isset($_GET['appealID'])){
    ...
    $statement = "select * from appeals where appealID = '$appealID'";
    $resultApp = mysqli_query($con, $statement);
    $rowApp = mysqli_fetch_array($resultApp);
    $orgName = $rowApp['OrganizationName'];
}
else{
...
<nav class="navbar navbar-expand-lg navbar-expand-md">
    ...
    <p class="ms-3 my-1 fst-italic">Representative: <strong><?php echo $_SESSION['username']?></strong></p>
    <h1 class="h1 my-3 p-0 text-center">List of applicants</h1>
    <?php
    $s = "select * from applicant where Organization = '$orgName'";
    ...
    ?>
        ...
        <thead>
            ...
            <td><a href="disbursementForm.php?<?php echo 'appealID='.$appealID?>&<?php echo 'applicantID='.$row['ID']?>" target="__blank">Disbursement Form of <?php echo $row["ID"]?></a></td>
            </tr>
            <?php
            $f++;
            }
