...
<body class="body">
    ...
    <div class="form-box container-fluid p-lg-5 p-md-5 p-2 my-5">
        <h1 class="h1 mb-1 p-0 text-lg-center text-md-center text-start">add documents</h1>
        <p class="mb-2 text-center fst-italic">Please provide us with your legal documents (bank documents, salary check etc)</p>
        <form action="registrationProcess.php" class="form mx-auto" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-5 text-center">
                <button type="submit" name="submit" class="button btn btn-success p-2 px-5">Done</button>
                <p><?php $message ?></p>
            </div>
        </form>
    </div><!--footer-->
