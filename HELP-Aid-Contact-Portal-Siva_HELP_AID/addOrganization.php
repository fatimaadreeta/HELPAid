<?php
  ...
  $sql = "SELECT * FROM organization WHERE organizationName = '$organizationName'";
  $result = mysqli_query($con, $sql);
  $num = mysqli_num_rows($result);

  if($num == 1){
    $message = "Organization exists.";
    $href = "addOrganization.html";
    $btn = "Try again";
  }
  else{
    $s = "INSERT INTO organization (organizationName, Address)
    VALUES ('$organizationName','$Address')";
    mysqli_query($con, $s);
    $message = "Organization added succesfully.";
    $href = "organization.php";
    $btn = "View Organization List";
            ...
            <button class="navbar-toggler navbar-toggler-right h-100 m-0" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="home.php"><b>BACK</b></a>
						<li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="organization.php"><b>VIEW ORGANIZATION</b></a>
                        </li>
						<li class="nav-item">
							    <a class="nav-link js-scroll-trigger" href="index.html"><b>LOG OUT&nbsp;(ADMIN)</b></a>
                        </li>
                        </li>
                    </ul>
                </div>
