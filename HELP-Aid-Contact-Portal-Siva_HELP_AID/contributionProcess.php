...
$s = "insert into contribution (CashAmount, PaymentVia, ReferenceNo, receivedDate, OrganizationName, appealID, Description, EstimatedValue) values ('$cashAmount','$paymentChannel','$referenceNo','$receivedDate','$orgName','$appealID','$description','$estimatedValue')";
...
<nav class="navbar navbar-expand-lg navbar-expand-md">
    ...
    <div class="successful-box w-50 mx-auto mb-5 text-center">
        <?php 
            $message = "Contribution added to system. Thank you!";
            $href = "./../appealsContribution.php";
            $value = "Add More Contribution"; 
        ?>
        <h1 class="h1 p-5"><?php echo $message ?></h1>
            
        <a href = "<?php echo $href?>" class="a d-inline-block p-2 px-5 btn btn-success m-3"> <?php echo $value ?></a>
        <a href = "./../index.html" class="a d-inline-block p-2 px-5 btn btn-success m-3">Log out</a>
