<?php
  ...
  if($num == 1){
    ...
    if($num_r == 1){
      ...
      $message = "Representative added. Kindly mail them their login details so they can login into the system";
    ...
    <body id="page-top">
      <nav class="navbar new navbar-expand-lg navbar-dark fixed-top p-0 m-0" id="mainNav">
            ...
            <a class="navbar-brand js-scroll-trigger h-100 m-0" href="#"><img src="img/helpaid_logo.jpg" alt="logo" width="130" height="60"></a>
                ...
                <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="addOrganization.html"><b>BACK</b></a>
						<li class="nav-item">
