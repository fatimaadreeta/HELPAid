...
$sql = "INSERT INTO appeals (OrganizationName, fromDate, toDate, description, outcome)
        VALUES ('$OrganizationName','$fromDate','$toDate', '$description', '$outcome')";
...
<nav class="navbar navbar-expand-lg navbar-expand-md">
    ...
    <div class="successful-box w-50 mx-auto mb-5 text-center">
        <?php 
            $message = "Appeal added";
            $href = "appeal.php";
            $value = "View Appeals List"; 
        ?>
        <h1 class="h1 p-5"><?php echo $message ?></h1>
        <form action="<?php echo $href ?>">
        <input type="hidden" name="" value="<?php echo $OrganizationName ?>">  
        <input type="submit" name="submit" class="a d-inline-block p-2 px-5 btn btn-success mb-4" value="<?php echo $value ?>"/>
        </form>
    </div>
